...
public class UnderlyingListJSONParser {
    ...
    public interface OnJSONCompletedListener {
        void OnJSONCompleted(UnderlyingList underlyingList);
    }
                ...
                try {
                    ...
                    while (true) {
                        ...
                        if (readLine != null) {
                            ...
                            UnderlyingListJSONParser.this.onJSONCompletedListener.OnJSONCompleted((UnderlyingList) objectMapper.readValue(sb.toString(), UnderlyingList.class));
                            return;
                        }
                    }
                } catch (Exception e) {
                    UnderlyingListJSONParser.this.onJSONFailedListener.OnJSONFailed(this, e);
                }
            }
        });
    }
