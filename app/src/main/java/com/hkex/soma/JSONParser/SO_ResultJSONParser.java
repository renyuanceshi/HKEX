...
public class SO_ResultJSONParser {
    ...
    public interface OnJSONCompletedListener {
        void OnJSONCompleted(SO_Result sO_Result);
    }
                ...
                try {
                    ...
                    while (true) {
                        ...
                        if (readLine != null) {
                            ...
                            SO_ResultJSONParser.this.onJSONCompletedListener.OnJSONCompleted((SO_Result) objectMapper.readValue(sb.toString(), SO_Result.class));
                            return;
                        }
                    }
                } catch (Exception e) {
                    SO_ResultJSONParser.this.onJSONFailedListener.OnJSONFailed(this, e);
                }
            }
        });
    }
