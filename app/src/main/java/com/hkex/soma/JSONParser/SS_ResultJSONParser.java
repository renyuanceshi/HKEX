...
public class SS_ResultJSONParser {
    ...
    public interface OnJSONCompletedListener {
        void OnJSONCompleted(SS_Result sS_Result);
    }
                ...
                try {
                    ...
                    while (true) {
                        ...
                        if (readLine != null) {
                            ...
                            SS_ResultJSONParser.this.onJSONCompletedListener.OnJSONCompleted((SS_Result) objectMapper.readValue(sb.toString(), SS_Result.class));
                            return;
                        }
                    }
                } catch (Exception e) {
                    SS_ResultJSONParser.this.onJSONFailedListener.OnJSONFailed(this, e);
                }
            }
        });
    }
