...
public class MS_StockJSONParser {
    ...
    public interface OnJSONCompletedListener {
        void OnJSONCompleted(MS_StocksResult mS_StocksResult);
    }
                ...
                try {
                    ...
                    while (true) {
                        ...
                        if (readLine != null) {
                            ...
                            MS_StockJSONParser.this.onJSONCompletedListener.OnJSONCompleted((MS_StocksResult) objectMapper.readValue(sb.toString(), MS_StocksResult.class));
                            return;
                        }
                    }
                } catch (Exception e) {
                    MS_StockJSONParser.this.onJSONFailedListener.OnJSONFailed(this, e);
                }
            }
        });
    }
