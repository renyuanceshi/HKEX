...
public class MSBannerJSONParser {
    ...
    public interface OnJSONCompletedListener {
        void OnJSONCompleted(MSBanner mSBanner);
    }
                ...
                try {
                    ...
                    while (true) {
                        ...
                        if (readLine != null) {
                            ...
                            MSBannerJSONParser.this.onJSONCompletedListener.OnJSONCompleted((MSBanner) objectMapper.readValue(sb.toString(), MSBanner.class));
                            return;
                        }
                    }
                } catch (Exception e) {
                    MSBannerJSONParser.this.onJSONFailedListener.OnJSONFailed(this, e);
                }
            }
        });
    }
