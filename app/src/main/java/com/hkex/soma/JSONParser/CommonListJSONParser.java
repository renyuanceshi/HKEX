...
public class CommonListJSONParser {
    ...
    public interface OnJSONCompletedListener {
        void OnJSONCompleted(CommonList commonList);
    }
                ...
                try {
                    ...
                    while (true) {
                        ...
                        if (readLine != null) {
                            ...
                            CommonListJSONParser.this.onJSONCompletedListener.OnJSONCompleted((CommonList) objectMapper.readValue(sb.toString(), CommonList.class));
                            return;
                        }
                    }
                } catch (Exception e) {
                    CommonListJSONParser.this.onJSONFailedListener.OnJSONFailed(this, e);
                }
            }
        });
    }
