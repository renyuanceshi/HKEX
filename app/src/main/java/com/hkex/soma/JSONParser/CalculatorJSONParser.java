...
public class CalculatorJSONParser {
    ...
    public interface OnJSONCompletedListener {
        void OnJSONCompleted(Calculator_Result calculator_Result);
    }
                ...
                try {
                    ...
                    while (true) {
                        ...
                        if (readLine != null) {
                            ...
                            CalculatorJSONParser.this.onJSONCompletedListener.OnJSONCompleted((Calculator_Result) objectMapper.readValue(sb.toString(), Calculator_Result.class));
                            return;
                        }
                    }
                } catch (Exception e) {
                    CalculatorJSONParser.this.onJSONFailedListener.OnJSONFailed(this, e);
                }
            }
        });
    }
