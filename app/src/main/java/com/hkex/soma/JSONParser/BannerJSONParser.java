...
public class BannerJSONParser {
    ...
    public interface OnJSONCompletedListener {
        void OnJSONCompleted(Banner_Result banner_Result);
    }
                ...
                try {
                    ...
                    while (true) {
                        ...
                        if (readLine != null) {
                            ...
                            BannerJSONParser.this.onJSONCompletedListener.OnJSONCompleted((Banner_Result) objectMapper.readValue(sb.toString(), Banner_Result.class));
                            return;
                        }
                    }
                } catch (Exception e) {
                    BannerJSONParser.this.onJSONFailedListener.OnJSONFailed(this, e);
                }
            }
        });
    }
