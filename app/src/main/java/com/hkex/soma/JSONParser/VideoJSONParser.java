...
public class VideoJSONParser {
    ...
    public interface OnJSONCompletedListener {
        void OnJSONCompleted(Video_Result video_Result);
    }
                ...
                try {
                    ...
                    while (true) {
                        ...
                        if (readLine != null) {
                            ...
                            VideoJSONParser.this.onJSONCompletedListener.OnJSONCompleted((Video_Result) objectMapper.readValue(sb.toString(), Video_Result.class));
                            return;
                        }
                    }
                } catch (Exception e) {
                    VideoJSONParser.this.onJSONFailedListener.OnJSONFailed(this, e);
                    e.printStackTrace();
                }
            }
        });
