...
public class DividendJSONParser {
    ...
    public interface OnJSONCompletedListener {
        void OnJSONCompleted(Dividend_Result dividend_Result);
    }
                ...
                try {
                    ...
                    while (true) {
                        ...
                        if (readLine != null) {
                            ...
                            DividendJSONParser.this.onJSONCompletedListener.OnJSONCompleted((Dividend_Result) objectMapper.readValue(sb.toString(), Dividend_Result.class));
                            return;
                        }
                    }
                } catch (Exception e) {
                    DividendJSONParser.this.onJSONFailedListener.OnJSONFailed(this, e);
                }
            }
        });
    }
