...
public class MS_IndicsJSONParser {
    ...
    public interface OnJSONCompletedListener {
        void OnJSONCompleted(MS_IndicesResult mS_IndicesResult);
    }
                ...
                try {
                    ...
                    while (true) {
                        ...
                        if (readLine != null) {
                            ...
                            MS_IndicsJSONParser.this.onJSONCompletedListener.OnJSONCompleted((MS_IndicesResult) objectMapper.readValue(sb.toString(), MS_IndicesResult.class));
                            return;
                        }
                    }
                } catch (Exception e) {
                    MS_IndicsJSONParser.this.onJSONFailedListener.OnJSONFailed(this, e);
                }
            }
        });
    }
