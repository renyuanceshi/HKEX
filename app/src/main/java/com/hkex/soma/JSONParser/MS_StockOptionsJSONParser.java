...
public class MS_StockOptionsJSONParser {
    ...
    public interface OnJSONCompletedListener {
        void OnJSONCompleted(MS_Options mS_Options);
    }
                ...
                try {
                    ...
                    while (true) {
                        ...
                        if (readLine != null) {
                            ...
                            MS_StockOptionsJSONParser.this.onJSONCompletedListener.OnJSONCompleted((MS_Options) objectMapper.readValue(sb.toString(), MS_Options.class));
                            return;
                        }
                    }
                } catch (Exception e) {
                    MS_StockOptionsJSONParser.this.onJSONFailedListener.OnJSONFailed(this, e);
                }
            }
        });
    }
