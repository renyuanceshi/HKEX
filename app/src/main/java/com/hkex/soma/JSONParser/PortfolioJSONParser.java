...
public class PortfolioJSONParser {
    ...
    public interface OnJSONCompletedListener {
        void OnJSONCompleted(Portfolio_Result portfolio_Result);
    }
                ...
                try {
                    ...
                    while (true) {
                        ...
                        if (readLine != null) {
                            ...
                            PortfolioJSONParser.this.onJSONCompletedListener.OnJSONCompleted((Portfolio_Result) objectMapper.readValue(sb.toString(), Portfolio_Result.class));
                            return;
                        }
                    }
                } catch (Exception e) {
                    PortfolioJSONParser.this.onJSONFailedListener.OnJSONFailed(this, e);
                }
            }
        });
    }
