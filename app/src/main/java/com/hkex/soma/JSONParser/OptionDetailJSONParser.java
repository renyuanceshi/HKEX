...
public class OptionDetailJSONParser {
    ...
    public interface OnJSONCompletedListener {
        void OnJSONCompleted(OptionDetail_Result optionDetail_Result);
    }
                ...
                try {
                    ...
                    while (true) {
                        ...
                        if (readLine != null) {
                            ...
                            OptionDetailJSONParser.this.onJSONCompletedListener.OnJSONCompleted((OptionDetail_Result) objectMapper.readValue(sb.toString(), OptionDetail_Result.class));
                            return;
                        }
                    }
                } catch (Exception e) {
                    OptionDetailJSONParser.this.onJSONFailedListener.OnJSONFailed(this, e);
                }
            }
        });
    }
