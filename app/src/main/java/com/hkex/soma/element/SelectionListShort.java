...
public class SelectionListShort extends LinearLayout {
    ...
    public SelectionListShort(Context context2) {
        super(context2);
    ...
    public SelectionListShort(Context context2, AttributeSet attributeSet) {
        super(context2, attributeSet);
        if (!isInEditMode()) {
            this.context = context2;
            this.selectionlist = ((LayoutInflater) context2.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.selectionlistshort, this, false);
            addView(this.selectionlist);
        }
    }
    ...
    public void initItems(int i, PopTypes popTypes, int i2, int i3, int i4) {
        ...
        this.dateDialog = new DatePickerDialog(this.context, new DatePickerDialog.OnDateSetListener() {
            public void onDateSet(DatePicker datePicker, int i, int i2, int i3) {
                ...
                SelectionListShort.this.setSelectedText(formatDate);
                if (SelectionListShort.this.onDateSelectedListener != null) {
                    SelectionListShort.this.onDateSelectedListener.onDateSelected(formatDate);
                }
            }
        }, i2, i3 - 1, i4);
    }
    ...
    public void initItems(String[] strArr, int i, PopTypes popTypes, int i2) {
        ...
        this.sDialog.setOnDialogItemClickListener(new SelectionDialog.OnDialogItemClickListener() {
            public void onDialogItemClicked(int i) {
                SelectionListShort.this.setSelectedIndex(i);
                SelectionListShort.this.sDialog.dismiss();
                if (SelectionListShort.this.onListItemChangeListener != null) {
                    SelectionListShort.this.onListItemChangeListener.onListItemChanged(i);
                }
            }
        });
        setSelectedIndex(i2);
    ...
    public void initLayoutClickListener(final PopTypes popTypes) {
        setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (SelectionListShort.this.isEnable) {
                    if (popTypes == PopTypes.DATE) {
                        SelectionListShort.this.dateDialog.show();
                    } else {
                        SelectionListShort.this.sDialog.show();
                    }
                    if (SelectionListShort.this.onLayoutClickListener != null) {
                        SelectionListShort.this.onLayoutClickListener.onLayoutClicked();
                    }
                }
            }
        });
    ...
    public void initLayoutClickListener(final PopTypes popTypes, final boolean z) {
        setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (SelectionListShort.this.isEnable) {
                    SelectionListShort.this.setGreyStyle(false);
                    Intent intent = new Intent();
                    intent.setClass(SelectionListShort.this.context, SearchPage.class);
                    intent.putExtra("typecode", popTypes.value);
                    intent.putExtra("isAutocomplete", z);
                    ((FragmentActivity) SelectionListShort.this.context).startActivityForResult(intent, 0);
                    if (SelectionListShort.this.onLayoutClickListener != null) {
                        SelectionListShort.this.onLayoutClickListener.onLayoutClicked();
                    }
                }
