...
public class SelectionDialog2line extends CustomDialog {
    ...
    public SelectionDialog2line(Context context2, String[] strArr) {
        super(context2);
    ...
    public void initListLayout(String[] strArr) {
        ...
        this.simpleDialogAdapter = new SimpleDialogAdapter(this.context, R.layout.list_dialog_simaple2line, strArr, 0);
        listView.setAdapter(this.simpleDialogAdapter);
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                if (SelectionDialog2line.this.onDialogItemClickListener != null) {
                    SelectionDialog2line.this.simpleDialogAdapter.setSelectedItem(i);
                    SelectionDialog2line.this.onDialogItemClickListener.onDialogItemClicked(i);
                }
            }
        });
    }
