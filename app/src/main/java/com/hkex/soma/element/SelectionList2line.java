...
public class SelectionList2line extends LinearLayout {
    ...
    private SelectionDialog2line sDialog;
    ...
    public SelectionList2line(Context context2) {
        super(context2);
    ...
    public SelectionList2line(Context context2, AttributeSet attributeSet) {
    ...
    public void initItems(int i, PopTypes popTypes, int i2, int i3, int i4) {
        ...
        this.dateDialog = new DatePickerDialog(this.context, new DatePickerDialog.OnDateSetListener() {
            public void onDateSet(DatePicker datePicker, int i, int i2, int i3) {
                ...
                SelectionList2line.this.setSelectedText(formatDate);
                if (SelectionList2line.this.onDateSelectedListener != null) {
                    SelectionList2line.this.onDateSelectedListener.onDateSelected(formatDate);
                }
            }
        }, i2, i3 - 1, i4);
    }
    ...
    public void initItems(String[] strArr, int i, PopTypes popTypes, int i2) {
        this.Items = strArr;
        initLayoutClickListener(popTypes);
        this.sDialog = new SelectionDialog2line(this.context, this.Items);
        ...
        this.sDialog.setOnDialogItemClickListener(new SelectionDialog2line.OnDialogItemClickListener() {
            public void onDialogItemClicked(int i) {
                SelectionList2line.this.setSelectedIndex(i);
                SelectionList2line.this.sDialog.dismiss();
                if (SelectionList2line.this.onListItemChangeListener != null) {
                    SelectionList2line.this.onListItemChangeListener.onListItemChanged(i);
                }
            }
        });
        setSelectedIndex(i2);
    ...
    public void initLayoutClickListener(final PopTypes popTypes) {
        setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (SelectionList2line.this.isEnable) {
                    if (popTypes == PopTypes.DATE) {
                        SelectionList2line.this.dateDialog.show();
                    } else {
                        SelectionList2line.this.sDialog.show();
                    }
                    if (SelectionList2line.this.onLayoutClickListener != null) {
                        SelectionList2line.this.onLayoutClickListener.onLayoutClicked();
                    }
                }
            }
        });
    ...
    public void initLayoutClickListener(final PopTypes popTypes, final boolean z) {
        setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (SelectionList2line.this.isEnable) {
                    SelectionList2line.this.setGreyStyle(false);
                    Intent intent = new Intent();
                    intent.setClass(SelectionList2line.this.context, SearchPage.class);
                    intent.putExtra("typecode", popTypes.value);
                    intent.putExtra("isAutocomplete", z);
                    ((FragmentActivity) SelectionList2line.this.context).startActivityForResult(intent, 0);
                    if (SelectionList2line.this.onLayoutClickListener != null) {
                        SelectionList2line.this.onLayoutClickListener.onLayoutClicked();
                    }
                }
